...
class LoanProfilePage extends StatefulWidget {
  final Loan loan;
  const LoanProfilePage({super.key, required this.loan, required Map<String, String> borrower});
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  (loan.terms[i]["paid"] ?? false) ? "Paid" : "Not Paid",
                  style: TextStyle(
                    color: (loan.terms[i]["paid"] ?? false) ? Colors.green : Colors.red,
                    fontSize: 12,
                  ),
                ),
              ],
