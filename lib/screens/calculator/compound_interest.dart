        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Dropdown box for Compound Interest at the top left
                Row(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text('Compound Interest:', style: TextStyle(color: Colors.black)),
                            Text('₱${compoundInterest == compoundInterest.toInt() ? '${compoundInterest.toInt()}' : compoundInterest.toStringAsFixed(2)}', style: const TextStyle(color: Colors.black)),
                          ],
                        ),
                        const SizedBox(height: 10),
                        Row(
                          ...
                          children: [
                            ...
                            Text('₱${totalAmount == totalAmount.toInt() ? '${totalAmount.toInt()}' : totalAmount.toStringAsFixed(2)}', style: const TextStyle(color: Colors.black)),
                          ],
                        ),
                        const SizedBox(height: 10),
                        Row(
